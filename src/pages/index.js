    ...
    >
      ...
      <div className="relative z-10 ">
        ...
        <div className="relative faded-bottom overflow-hidden">
          <img
            className="w-screen object-cover overflow-hidden grow-animation"
            src="cover.png"
            alt="Cover Image"
          />
          <div className="absolute text-white top-0 left-0 flex flex-col text-left ml-[150px]">
            ...
            <p className="mt-[100px] text-8xl font-Pretendard-ExBold">
              동자동 폭염 불평등 지도로 보는
              <br />
              여름의 비극
            </p>
            <p className="mt-[250px] text-2xl">
              {
        ...
        <div className="mt-[550px] h-screen text-white flex justify-center relative">
          ...
          <p className="absolute font-Pretendard-ExBold text-6xl">
